            ...
            <nav class="bg-gray-800">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            <div class="shrink-0">
                                <img class="size-8"
                                    src="{{asset("img/fairy-logo-icon.png")}}"
                                    alt="Your Company" />
                            </div>
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <x-nav-link href="/jobs" :active="request()->is('jobs')">{{ __("Jobs") }}</x-nav-link>
                                    <x-nav-link href="/contact" :active="request()->is('contact')">{{ __("Contact") }}</x-nav-link>
                                </div>
                            </div>
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-4 flex items-center md:ml-6">
                                @guest
                                    <x-nav-link href="{{ route('user.index') }}" :active="request()->is('user/login')">{{ __("Login") }}</x-nav-link>
                                        ...
                                        <div>
                                            <button type="button"
                                                ...
                                                <img class="size-8 rounded-full"
                                                    src="{{ asset("img/fairy-profile.jpg") }}"
                                                    alt="" />
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="md:hidden" id="mobile-menu">
                    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                        ...
                        <a href="/about"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">{{ __("Contact") }}</a>
                        <a href="/contact"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">{{ __("About") }}</a>
                    </div>
